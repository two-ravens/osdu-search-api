...
* [QueryWithCursor](docs/sdks/searchapi/README.md#querywithcursor) - Queries the index using cursor for the input request criteria.
* [QueryRecords](docs/sdks/searchapi/README.md#queryrecords) - Queries the index for the input request criteria.
